...
import { HOOK_MARKER } from './prepare-commit-msg.js';
...
// is missing). A hook is per-clone state, so "is AIDA set up here?" and "is
// AIDA set up in this repo?" are different questions — #75.
...
// trusting `.aida.json`: config is committed and shared, the hook is not.
