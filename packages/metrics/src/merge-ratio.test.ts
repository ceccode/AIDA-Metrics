      ...
      commits: [
        {
          ...
          tags: { ai: true, attribution: 'ai' as const, mode: 'agent' as const, modeEvidence: 'inferred' as const, level: 'explicit' as const, sources: ['trailer:AI: true'] },
        ...
        },
        {
          ...
          parents: [],
          inDefaultBranchAncestry: true,
          tags: { ai: false, attribution: 'unknown' as const, mode: 'unknown' as const, modeEvidence: 'none' as const, level: 'none' as const, sources: [] },
    ...
    const mockCommitStream: CommitStream = {
      ...
      commits: [
        ...
        },
        {
          ...
          inDefaultBranchAncestry: true,
          tags: { ai: false, attribution: 'human' as const, mode: 'none' as const, modeEvidence: 'declared' as const, level: 'none' as const, sources: [] },
        },
        {
          ...baseCommit,
          hash: 'human2',
